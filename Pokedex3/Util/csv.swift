...
public class CSV {
    ...
    public init(content: String?, delimiter: CharacterSet, encoding: String.Encoding) throws{
    ...
    public convenience init(contentsOfURL url: String) throws {
        ...
        try self.init(content: csvString,delimiter:comma, encoding: String.Encoding.utf8)
    }
